document.querySelectorAll(".catalog__item").forEach((item) => {
  item.addEventListener("click", (event) => {
    ...
    const productPrice = product.querySelector(".catalog__item-price")
      .textContent;
    const productPriceOld = product.querySelector(".catalog__item-price-old")
      .textContent;
    const productStructure = product.querySelector(".catalog__item-structure")
      .textContent;
